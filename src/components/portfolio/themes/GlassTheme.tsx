  ...
  return (
    <div className="bg-[#020817] min-h-screen text-[#e2e8f0] font-sans selection:bg-[#3b82f6] selection:text-white scroll-smooth relative overflow-x-hidden">
      ...
      <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-10 px-8 py-3 bg-[#020817]/70 border border-white/10 rounded-full backdrop-blur-xl">
        ...
        <section id="hero" className="min-h-screen flex items-center justify-center pt-24 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <motion.h1 
               ...
               className="text-6xl md:text-9xl font-extrabold leading-[0.9] mb-8 tracking-tighter"
            >
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {data.skills.map((skill, i) => (
                  <motion.div 
                    key={skill} 
                    {...fadeIn}
                    className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md group hover:bg-white/10 transition-all hover:border-[#3b82f6]/30"
                  >
                    <div className="text-[9px] text-[#64748b] mb-4 font-bold tracking-[2px]">NODE_{i + 1}</div>
                    <div className="text-sm font-bold text-white group-hover:text-[#60a5fa] transition-colors uppercase tracking-widest">{skill}</div>
                  </motion.div>
                ))}
             </div>
          </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {data.projects.map((proj, i) => (
                 <motion.div 
                   key={i} 
                   {...fadeIn}
                   className="p-10 bg-white/[0.02] border border-white/5 rounded-3xl backdrop-blur-2xl relative overflow-hidden group hover:bg-white/[0.04] transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_40px_rgba(59,130,246,0.1)]"
                 >
      ...
      {pData.sectionsVisibility.contact && (
        <section id="contact" className="py-48 px-6 text-center">
           <motion.div 
             {...fadeIn}
             className="max-w-xl mx-auto p-12 bg-white/5 border border-white/10 rounded-[2rem] backdrop-blur-2xl relative shadow-2xl"
           >
